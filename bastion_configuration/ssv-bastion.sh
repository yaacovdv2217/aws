...
BASTION_IP="107.23.63.216"
BASTION_USER="ec2-user"
BASTION_KEY="/Users/yaacov/desktop/pems/key_pems_aws/aws_bootcamp_n.virginia/bootcamp_yaacov_key_pem.pem"
